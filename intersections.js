function intersectionLines(container, d1, d2) {
    ...
    pointsItems.push({ x: ix, y: iy, size: 3 });
    return intersectionPoint(container, pointsItems[5], { lwidth: 3, clrf: isIntersection ? '#8B0000' : 'black', clr: '#DC143C' });
}

function intersectionCircles(container, d1, d2) {
